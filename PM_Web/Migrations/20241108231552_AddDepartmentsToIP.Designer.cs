...
namespace PM.Migrations
{
    ...
    [Migration("20241108231552_AddDepartmentsToIP")]
    partial class AddDepartmentsToIP
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PM.Models.ActivityDivision", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PM.Models.BOQDivision", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<string>("Boqs")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PM.Models.InterfacePoint", b =>
                {
                    ...
                    b.Property<int?>("ScopePackage1Id")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("ScopePackage2Id")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("System1Id")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("System2Id")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ScopePackage1Id");

                    b.HasIndex("ScopePackage2Id");

                    b.HasIndex("System1Id");

                    b.HasIndex("System2Id");
            ...
            modelBuilder.Entity("PM.Models.ScopePackageDepartment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ScopePackageId");

                    b.ToTable("ScopePackageDepartments");
                });
            ...
            modelBuilder.Entity("PM.Models.InterfacePoint", b =>
                {
                    b.HasOne("PM.Models.ScopePackageDepartment", "Department1")
                        .WithMany()
                        .HasForeignKey("Department1Id");

                    b.HasOne("PM.Models.ScopePackageDepartment", "Department2")
                        .WithMany()
                        .HasForeignKey("Department2Id");

                    b.HasOne("PM.Models.Project", "Project")
                        .WithMany("InterfacePoints")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PM.Models.ScopePackage", "ScopePackage1")
                        .WithMany()
                        .HasForeignKey("ScopePackage1Id")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("PM.Models.ScopePackage", "ScopePackage2")
                        .WithMany()
                        .HasForeignKey("ScopePackage2Id")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("PM.Models._System", "System1")
                        .WithMany()
                        .HasForeignKey("System1Id")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("PM.Models._System", "System2")
                        .WithMany()
                        .HasForeignKey("System2Id")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("ScopePackage1");

                    b.Navigation("ScopePackage2");

                    b.Navigation("System1");

                    b.Navigation("System2");
                });
            ...
            modelBuilder.Entity("PM.Models.ScopePackageDepartment", b =>
                {
                    ...
                    b.HasOne("PM.Models.ScopePackage", "ScopePackage")
                        .WithMany()
                        .HasForeignKey("ScopePackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Project");

                    b.Navigation("ScopePackage");
                });
            ...
            modelBuilder.Entity("PM.Models.Project", b =>
                {
                    ...
                    b.Navigation("ActivityDivisions");

                    b.Navigation("BOQDivisions");

                    b.Navigation("BOQs");

                    b.Navigation("Departments");

                    b.Navigation("InterfacePoints");
